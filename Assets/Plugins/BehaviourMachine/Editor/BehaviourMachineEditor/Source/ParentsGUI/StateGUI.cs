...
namespace BehaviourMachineEditor
{
    ...
    public class StateGUI
    {
        ...
        public StateColor m_SearchColor { get; private set; }
        ...
        /// </summary>
        protected virtual void SetWindowColor(StateColor stateColor)
        {
            if (m_State != null)
            {
        ...
        {
            m_SearchColor = m_State.searchColor;
            if (m_SearchColor != StateColor.Grey && m_State.color != m_SearchColor)
            {
                SetWindowColor(m_SearchColor);
                this.Refresh();
            }
        }
