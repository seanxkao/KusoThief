...
namespace BehaviourMachineEditor
{
    ...
    public class BehaviourWindow : EditorWindow
    {
        ...
        /// </summary>
        public static ParentBehaviour activeParent
        {
            get { return EditorUtility.InstanceIDToObject(s_ActiveParentID) as ParentBehaviour; }
            set
            {
                // New parent?
        ...
        /// </summary>
        public static StateTransition activeTransition
        {
            get { return s_ActiveTransition; }
            set
            {
                TransitionDragAndDrop.AcceptDrag();
